  ...
  const applications = [
    {
      ...
      updateMessage: "Your application has been shortlisted! The producer will contact you soon.",
    },
    {
      id: "2",
      jobId: "j2",
    ...
    },
    {
      ...
      updateMessage: "Thank you for your interest. We've decided to move forward with another candidate.",
    },
    {
      id: "4",
      jobId: "j4",
      ...
      updateMessage: "Congratulations! You've been selected for this position. Contract details will follow.",
    },
  ]
      ...
      <main className="max-w-7xl mx-auto px-6 py-8">
              ...
              <CardContent className="p-6">
                <div className="flex items-start justify-between mb-4">
                  <div className="flex-1">
                    ...
                    <p className="text-purple-600 font-medium mb-3">{application.company}</p>
                    <div className="flex items-center space-x-4 text-sm text-gray-600 mb-4">
                      ...
                      <span className="text-green-600 font-medium">{application.matchScore}% Match</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-gray-50 rounded-lg p-4 mb-4">
                  ...
                  <p className="text-gray-700 text-sm">{application.updateMessage}</p>
                </div>
        ...
        {filteredApplications.length === 0 && (
          <div className="text-center py-12">
            ...
            <Link href="/jobs">
              <Button className="bg-purple-600 hover:bg-purple-700">Browse Available Jobs</Button>
            </Link>
          </div>
        )}
      </main>
